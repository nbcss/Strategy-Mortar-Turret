...
local hypnosis_time = 45
local hypnosis_chance = 25
...
data:extend {
        ...
        custom_tooltip_fields = {
            {
                ...
                value = { "seconds", tostring(hypnosis_time) },
            },
            {
                name = { "strategy-mortar-turret.hypnosis-max-chance" },
                value = { "format-percent", tostring(hypnosis_chance) },
            }
        },
    ...
    },
    {
        ...
        update_effects = {
            {
                time_cooldown = 10,
                initial_time_cooldown = hypnosis_time * 60,
                effect = {
                    type = "script",
